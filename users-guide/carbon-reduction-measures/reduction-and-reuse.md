...
* **Increasing forest carbon stocks**. Carbon storage in wood products can only be claimed if the carbon stock of the source forest is increasing. This means that the forest area is growing (afforestation), that selective logging is used to keep carbon stocks in place, and that afforestation does not come at the cost of converting ecologically sensitive or agricultural land.&#x20;
